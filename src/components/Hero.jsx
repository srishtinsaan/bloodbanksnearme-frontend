  ...
  return (
    <div id="app-container" className="mb-0 relative min-h-screen w-full bg-black overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: "radial-gradient(circle, rgba(255, 252, 252, 0.15) 1px, transparent 1px)",
      ...
      <div className="relative z-10 flex flex-col items-center justify-center px-4 pt-10 pb-1">
        <div>
          <h1
            className="text-3xl md:text-5xl lg:text-6xl font-bold text-center mb-6 mt-20 flex justify-center items-center"
            style={{ color: "#ff3b63" }}
          >
      ...
      <p className="text-center text-white/90 lg:text-[110%] text-base px-4 sm:px-10 md:px-20 lg:mb-10 lg:px-70 mt-10">
        <span className="font-bold italic">BloodConnect</span> helps you find the nearest and most reliable blood banks instantly. Whether it’s an emergency or regular need, our platform connects you to life-saving resources with just a few clicks.
      </p>
    </div>
  );
}